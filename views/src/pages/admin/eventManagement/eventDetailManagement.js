      ...
      <div className="container px-5 py-16 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              <button onClick={handleLike} className={`mr-auto rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4 ${heartColor}`}>
                <svg
                fill="currentColor"
              ...
              <Link className="flex mr-4 text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded"
                to={`/admin/event-management/edit/${id}`}
              >
                Edit
              </Link>
