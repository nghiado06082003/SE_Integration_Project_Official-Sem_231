            ...
            <div className='bg-white border border-gray-200 rounded-lg shadow-xl md:flex-row rounded-lg shadow md:flex-row mt-4 mb-4'>
                ...
                <div className='flex justify-end mx-2 my-2'>
                    <div className="inline-flex items-center rounded-md shadow-sm">
                        <Link 
                            className="text-slate-800 hover:text-primary-700 text-sm bg-white hover:bg-slate-100 border border-slate-200 rounded-l-lg font-medium px-4 py-2 inline-flex space-x-1 items-center"
                            to={`/admin/event-management/edit/${item.post_id}`}
                        >
                            <span>
